<?php
namespace App\Http\Controllers\Graph\Implementations ;

use App\Http\Controllers\Graph\CircularDependencyException;
use App\Http\Controllers\Graph\ElementNotFoundException;
use App\Http\Controllers\Graph\TopSortInterface ;
/**
...
class ArraySort extends BaseImplementation implements TopSortInterface
{
    ...
    {
        $this->status = $this->throwCircularExceptionIfNeeded($element, $parents);
